...
const SCHLIEREN_ALPHA_MUL = 0.90;
const SCHLIEREN_THICKNESS_MUL = 0.86;
const LIGHT_SCHLIEREN_ALPHA_MUL = 1.28;
...
function drawSchliere(item, index) {
  ...
  const alpha = item.alpha * item.visibility * SCHLIEREN_ALPHA_MUL * (item.light ? LIGHT_SCHLIEREN_ALPHA_MUL : 1);
